...
document.getElementById("btn-update").onclick = function() { 
    // get input values 
    var_val_indo = document.getElementById("id-indo").value;
    var_val_fran = document.getElementById("id-fran").value;
    var_val_cana = document.getElementById("id-cana").value; 
    var_val_usa = document.getElementById("id-usa").value; 
    var_val_arge = document.getElementById("id-arge").value; 
